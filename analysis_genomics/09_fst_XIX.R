...
snp_pruned <- read.table("data/snp_tables/whtstbk_2020_MAF_0.01_XIX_pruned.txt", h = T)

# the UNpruned snp table
snp_tab <- read.table("data/snp_tables/whtstbk_2020_MAF_0.01_XIX_unpruned.txt", h = T)
...
# write out
saveRDS(fst_df, "data/stats/fst_outflank_snp_XIX.rds")
...
# write out
saveRDS(pbs_df, "data/stats/pbs_df_snp_XIX.rds")
...
# write out
saveRDS(fst_100k, "data/stats/fst_100k_XIX.rds")
