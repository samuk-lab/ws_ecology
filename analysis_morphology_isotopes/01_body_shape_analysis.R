...
sherrat_pca_plot(pc1 = 1, pc2 = 2, landmark_gpa = landmark_gpa, file_name = "figures/FigureS2A.pdf",
                 group_factor = plot_groups, label = morpho_sub$id, correct_allometry = TRUE)


sherrat_pca_plot(pc1 = 3, pc2 = 4, landmark_gpa = landmark_gpa, file_name = "figures/FigureS2B.pdf",
