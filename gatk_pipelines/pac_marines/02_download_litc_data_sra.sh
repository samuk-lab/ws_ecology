...
#LITC fish
#srx_accessions="SRX544906 SRX543375 SRX543563 SRX544893 SRX544910"

#KODK KODK MANC MANC
#srx_accessions="SRX621222 SRX608534 SRX608613 SRX608531"
...
for srx in $srx_accessions
	...
	while read srr
		...
		$sratoolkit/fastq-dump --split-files /SciBorg/array0/samuk/ncbi/public/sra/$srr.sra --outdir data/raw/fastq/$srx
